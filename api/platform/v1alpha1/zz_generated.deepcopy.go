...
func (in *AffinityInjector) DeepCopyInto(out *AffinityInjector) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new AffinityInjector.
func (in *AffinityInjector) DeepCopy() *AffinityInjector {
	if in == nil {
		return nil
	}
	out := new(AffinityInjector)
	in.DeepCopyInto(out)
	return out
}
