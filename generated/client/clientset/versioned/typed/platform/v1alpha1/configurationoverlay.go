...
// ConfigurationOverlaysGetter has a method to return a ConfigurationOverlayInterface.
...
// configurationOverlays implements ConfigurationOverlayInterface
type configurationOverlays struct {
	client rest.Interface
	ns     string
}

// newConfigurationOverlays returns a ConfigurationOverlays
func newConfigurationOverlays(c *PlatformV1alpha1Client, namespace string) *configurationOverlays {
	return &configurationOverlays{
		client: c.RESTClient(),
		ns:     namespace,
	}
}
...
func (c *configurationOverlays) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.ConfigurationOverlay, err error) {
	result = &v1alpha1.ConfigurationOverlay{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("configurationoverlays").
		Name(name).
...
func (c *configurationOverlays) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.ConfigurationOverlayList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.ConfigurationOverlayList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("configurationoverlays").
...
func (c *configurationOverlays) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *configurationOverlays) Create(ctx context.Context, configurationOverlay *v1alpha1.ConfigurationOverlay, opts v1.CreateOptions) (result *v1alpha1.ConfigurationOverlay, err error) {
	result = &v1alpha1.ConfigurationOverlay{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("configurationoverlays").
...
func (c *configurationOverlays) Update(ctx context.Context, configurationOverlay *v1alpha1.ConfigurationOverlay, opts v1.UpdateOptions) (result *v1alpha1.ConfigurationOverlay, err error) {
	result = &v1alpha1.ConfigurationOverlay{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("configurationoverlays").
		Name(configurationOverlay.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(configurationOverlay).
		Do(ctx).
		Into(result)
...
func (c *configurationOverlays) UpdateStatus(ctx context.Context, configurationOverlay *v1alpha1.ConfigurationOverlay, opts v1.UpdateOptions) (result *v1alpha1.ConfigurationOverlay, err error) {
	result = &v1alpha1.ConfigurationOverlay{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("configurationoverlays").
...
func (c *configurationOverlays) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *configurationOverlays) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *configurationOverlays) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.ConfigurationOverlay, err error) {
	result = &v1alpha1.ConfigurationOverlay{}
