...
// LogTailsGetter has a method to return a LogTailInterface.
...
// logTails implements LogTailInterface
type logTails struct {
	client rest.Interface
	ns     string
}

// newLogTails returns a LogTails
func newLogTails(c *PlatformV1alpha1Client, namespace string) *logTails {
	return &logTails{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *logTails) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.LogTail, err error) {
	result = &v1alpha1.LogTail{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("logtails").
		Name(name).
...
func (c *logTails) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.LogTailList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.LogTailList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("logtails").
...
func (c *logTails) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *logTails) Create(ctx context.Context, logTail *v1alpha1.LogTail, opts v1.CreateOptions) (result *v1alpha1.LogTail, err error) {
	result = &v1alpha1.LogTail{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("logtails").
...
func (c *logTails) Update(ctx context.Context, logTail *v1alpha1.LogTail, opts v1.UpdateOptions) (result *v1alpha1.LogTail, err error) {
	result = &v1alpha1.LogTail{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("logtails").
...
func (c *logTails) UpdateStatus(ctx context.Context, logTail *v1alpha1.LogTail, opts v1.UpdateOptions) (result *v1alpha1.LogTail, err error) {
	result = &v1alpha1.LogTail{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("logtails").
...
func (c *logTails) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *logTails) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *logTails) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.LogTail, err error) {
	result = &v1alpha1.LogTail{}
