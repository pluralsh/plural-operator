...
// StatefulSetResizesGetter has a method to return a StatefulSetResizeInterface.
...
// statefulSetResizes implements StatefulSetResizeInterface
type statefulSetResizes struct {
	client rest.Interface
	ns     string
}

// newStatefulSetResizes returns a StatefulSetResizes
func newStatefulSetResizes(c *PlatformV1alpha1Client, namespace string) *statefulSetResizes {
	return &statefulSetResizes{
		client: c.RESTClient(),
		ns:     namespace,
	}
}
...
func (c *statefulSetResizes) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.StatefulSetResize, err error) {
	result = &v1alpha1.StatefulSetResize{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("statefulsetresizes").
		Name(name).
...
func (c *statefulSetResizes) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.StatefulSetResizeList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.StatefulSetResizeList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("statefulsetresizes").
...
func (c *statefulSetResizes) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *statefulSetResizes) Create(ctx context.Context, statefulSetResize *v1alpha1.StatefulSetResize, opts v1.CreateOptions) (result *v1alpha1.StatefulSetResize, err error) {
	result = &v1alpha1.StatefulSetResize{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("statefulsetresizes").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(statefulSetResize).
		Do(ctx).
		Into(result)
	return
}
...
func (c *statefulSetResizes) Update(ctx context.Context, statefulSetResize *v1alpha1.StatefulSetResize, opts v1.UpdateOptions) (result *v1alpha1.StatefulSetResize, err error) {
	result = &v1alpha1.StatefulSetResize{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("statefulsetresizes").
		Name(statefulSetResize.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(statefulSetResize).
		Do(ctx).
		Into(result)
...
func (c *statefulSetResizes) UpdateStatus(ctx context.Context, statefulSetResize *v1alpha1.StatefulSetResize, opts v1.UpdateOptions) (result *v1alpha1.StatefulSetResize, err error) {
	result = &v1alpha1.StatefulSetResize{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("statefulsetresizes").
...
func (c *statefulSetResizes) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *statefulSetResizes) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *statefulSetResizes) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.StatefulSetResize, err error) {
	result = &v1alpha1.StatefulSetResize{}
