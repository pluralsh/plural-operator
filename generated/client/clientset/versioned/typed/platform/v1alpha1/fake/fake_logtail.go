...
var logtailsResource = schema.GroupVersionResource{Group: "platform.plural.sh", Version: "v1alpha1", Resource: "logtails"}

var logtailsKind = schema.GroupVersionKind{Group: "platform.plural.sh", Version: "v1alpha1", Kind: "LogTail"}
...
func (c *FakeLogTails) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.LogTail, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewGetAction(logtailsResource, c.ns, name), &v1alpha1.LogTail{})

	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.LogTail), err
}
...
func (c *FakeLogTails) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.LogTailList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewListAction(logtailsResource, logtailsKind, c.ns, opts), &v1alpha1.LogTailList{})
	...
	list := &v1alpha1.LogTailList{ListMeta: obj.(*v1alpha1.LogTailList).ListMeta}
	for _, item := range obj.(*v1alpha1.LogTailList).Items {
...
func (c *FakeLogTails) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
		InvokesWatch(testing.NewWatchAction(logtailsResource, c.ns, opts))
...
func (c *FakeLogTails) Create(ctx context.Context, logTail *v1alpha1.LogTail, opts v1.CreateOptions) (result *v1alpha1.LogTail, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewCreateAction(logtailsResource, c.ns, logTail), &v1alpha1.LogTail{})
...
func (c *FakeLogTails) Update(ctx context.Context, logTail *v1alpha1.LogTail, opts v1.UpdateOptions) (result *v1alpha1.LogTail, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateAction(logtailsResource, c.ns, logTail), &v1alpha1.LogTail{})
...
func (c *FakeLogTails) UpdateStatus(ctx context.Context, logTail *v1alpha1.LogTail, opts v1.UpdateOptions) (*v1alpha1.LogTail, error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateSubresourceAction(logtailsResource, "status", c.ns, logTail), &v1alpha1.LogTail{})
...
func (c *FakeLogTails) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteActionWithOptions(logtailsResource, c.ns, name, opts), &v1alpha1.LogTail{})
...
func (c *FakeLogTails) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	action := testing.NewDeleteCollectionAction(logtailsResource, c.ns, listOpts)

	_, err := c.Fake.Invokes(action, &v1alpha1.LogTailList{})
	return err
}
...
func (c *FakeLogTails) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.LogTail, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(logtailsResource, c.ns, name, pt, data, subresources...), &v1alpha1.LogTail{})
