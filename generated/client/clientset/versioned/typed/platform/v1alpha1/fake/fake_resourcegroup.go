...
var resourcegroupsResource = schema.GroupVersionResource{Group: "platform.plural.sh", Version: "v1alpha1", Resource: "resourcegroups"}

var resourcegroupsKind = schema.GroupVersionKind{Group: "platform.plural.sh", Version: "v1alpha1", Kind: "ResourceGroup"}
...
func (c *FakeResourceGroups) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteActionWithOptions(resourcegroupsResource, c.ns, name, opts), &v1alpha1.ResourceGroup{})
