...
var proxiesResource = schema.GroupVersionResource{Group: "platform.plural.sh", Version: "v1alpha1", Resource: "proxies"}

var proxiesKind = schema.GroupVersionKind{Group: "platform.plural.sh", Version: "v1alpha1", Kind: "Proxy"}
...
func (c *FakeProxies) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteActionWithOptions(proxiesResource, c.ns, name, opts), &v1alpha1.Proxy{})
