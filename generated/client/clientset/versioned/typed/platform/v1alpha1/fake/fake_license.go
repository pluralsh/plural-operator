...
var licensesResource = schema.GroupVersionResource{Group: "platform.plural.sh", Version: "v1alpha1", Resource: "licenses"}

var licensesKind = schema.GroupVersionKind{Group: "platform.plural.sh", Version: "v1alpha1", Kind: "License"}
...
func (c *FakeLicenses) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteActionWithOptions(licensesResource, c.ns, name, opts), &v1alpha1.License{})
