	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.PlatformV1alpha1().Proxies(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.PlatformV1alpha1().Proxies(namespace).Watch(context.TODO(), options)
			},
		},
		&platformv1alpha1.Proxy{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *proxyInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&platformv1alpha1.Proxy{}, f.defaultInformer)
}
