...
// StatefulSetResizes returns a StatefulSetResizeInformer.
func (v *version) StatefulSetResizes() StatefulSetResizeInformer {
	return &statefulSetResizeInformer{factory: v.factory, namespace: v.namespace, tweakListOptions: v.tweakListOptions}
}
