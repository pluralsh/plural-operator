	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.PlatformV1alpha1().Runbooks(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.PlatformV1alpha1().Runbooks(namespace).Watch(context.TODO(), options)
			},
		},
		&platformv1alpha1.Runbook{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *runbookInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&platformv1alpha1.Runbook{}, f.defaultInformer)
}
