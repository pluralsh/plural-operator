...
// SlashCommandsGetter has a method to return a SlashCommandInterface.
...
// slashCommands implements SlashCommandInterface
type slashCommands struct {
	client rest.Interface
	ns     string
}

// newSlashCommands returns a SlashCommands
func newSlashCommands(c *PlatformV1alpha1Client, namespace string) *slashCommands {
...
func (c *slashCommands) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.SlashCommand, err error) {
	result = &v1alpha1.SlashCommand{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *slashCommands) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.SlashCommandList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.SlashCommandList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("slashcommands").
...
func (c *slashCommands) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *slashCommands) Create(ctx context.Context, slashCommand *v1alpha1.SlashCommand, opts v1.CreateOptions) (result *v1alpha1.SlashCommand, err error) {
	result = &v1alpha1.SlashCommand{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("slashcommands").
...
func (c *slashCommands) Update(ctx context.Context, slashCommand *v1alpha1.SlashCommand, opts v1.UpdateOptions) (result *v1alpha1.SlashCommand, err error) {
	result = &v1alpha1.SlashCommand{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("slashcommands").
...
func (c *slashCommands) UpdateStatus(ctx context.Context, slashCommand *v1alpha1.SlashCommand, opts v1.UpdateOptions) (result *v1alpha1.SlashCommand, err error) {
	result = &v1alpha1.SlashCommand{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("slashcommands").
...
func (c *slashCommands) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *slashCommands) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *slashCommands) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.SlashCommand, err error) {
	result = &v1alpha1.SlashCommand{}
